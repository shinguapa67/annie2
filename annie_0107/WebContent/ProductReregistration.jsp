...
<div class="contanier">
	...
	<h2 style="text-align:center;">상품 재등록</h2>
		...
		<textarea rows="5" cols="120" value="<%-- <%= %> --%>"></textarea>
		<form action="#" method="post">
		<h4 style="display:inline-flex;float:left;margin-top:20px;">상품정보 입력</h4>
		<h6 style="display:inline-flex;margin-top:20px;margin-left:20px;float:left;">모든 항목을 정확하게 기입하세요</h6>
