...
<div class="main">
	...
	<table class="table" >
    	<tr>
         ...
         <tr>
            <td style="width:120px;"><label for="title"> 제목</label></td>
            <td>
            	 <input type="text" name="title" style="width:90%;height:40px;border:none;"placeholder="제목을 입력해주세요"/>
          </tr> 
          <tr>
