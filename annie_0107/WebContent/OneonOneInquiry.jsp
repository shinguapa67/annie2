...
<div class="show-table" >
	<table class="table" >
    	<tr>
           <td colspan="4"><h2 style="diaplay:inline-flex;">1:1문의</h2>
           <a href="#"><button style="float:right;diaplay:inline-flex;background-color:#bab3b9;color:white;" type="button" class="btn">1:1문의등록</button></a>
         	</td>
         </tr>
         <tr>
            <td>문의번호</td>
      ...
      <%-- <c:if test="${empty }"><h3>내역이 없습니다.</h3></c:if> --%>
           	<td>0011<%-- ${vo. } --%></td>
           	<td>2020.01.30<%-- ${vo. } --%></td>
           	<td>Field Luxe의 배송과정은 어떻게 진행되나요?</td>
            <td>미응답<%-- ${vo. } --%></td>
            <%-- </c:forEach> --%>
           </tr>
