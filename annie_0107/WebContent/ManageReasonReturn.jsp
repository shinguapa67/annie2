...
<h3 style="width:900px;">반려사유 등록</h3>
	<div style="width:700px;">
	 <div class="col-md-6 col-sm-12" style="margin-top:50px;">
	 	<img alt="" src="img/handbag1.jpg<%-- <%= %> --%>" style="height:150px;marign-right:50px;">
	 </div>
	 <div class="col-md-6 col-sm-12" style="margin-top:50px;">
	 	<table class="table">
	 		<tr>
	  ...
	  <div class="col-md-12 col-sm-12" style="margin-top:50px;width:850px;">
	 	<h4>반려사유</h4>
	 	<hr>
	 	<textarea rows="10" cols="120"></textarea>
	 	<div style="text-align:center;margin-bottom:200px;">
			<a href="#" type="button" class="btn btn-default" style="width:150px;background-color:#8284ff;color:white;" onclick="return confirm('등록하시겠습니까?')" >등록</a>
			<a href="#" type="button" class="btn btn-default" style="width:150px;background-color:#ebcee8;" onclick="goBack()">취소</a>
	  	</div>
	  </div>
